...
##Services 
#Source: Data pulled directly from QWI using NAICS codes 44-45 Retail Trade and 72 Accommodation and Food Services

county_services <- read_xlsx("/Users/nikkivandenHeever/Documents/Documents/1_School/1_Carnegie Mellon/Research/2020-2022 NSF Rapid/Actual Data/Final Data Set for Nature Version/Demographics/Service/Service_Sector_All_Counties_2020Q1.xlsx")
...
gt::gtsave(tbl_merge_2020_MSFT_Service, file = "/Users/nikkivandenHeever/Documents/Documents/1_School/1_Carnegie Mellon/Research/2020-2022 NSF Rapid/Writing/For Nature Journal/Final Regression Tables/2020 MSFT High Service TEST.png")
...
gt::gtsave(tbl_merge_2020_MSFT_Service, file = "/Users/nikkivandenHeever/Documents/Documents/1_School/1_Carnegie Mellon/Research/2020-2022 NSF Rapid/Writing/For Nature Journal/Final Regression Tables/2020 MSFT Low Service TEST.png")
...
gt::gtsave(tbl_merge_2019_MSFT_Service, file = "/Users/nikkivandenHeever/Documents/Documents/1_School/1_Carnegie Mellon/Research/2020-2022 NSF Rapid/Writing/For Nature Journal/Final Regression Tables/2019 MSFT High Service TEST.png")
...
gt::gtsave(tbl_merge_2019_MSFT_Service, file = "/Users/nikkivandenHeever/Documents/Documents/1_School/1_Carnegie Mellon/Research/2020-2022 NSF Rapid/Writing/For Nature Journal/Final Regression Tables/2019 MSFT Low Service TEST.png")
...
full_df_censustract_treat <- full_df_censustract[full_df_censustract$ookla_50_or_more_2020== "1",]
...
bb_2020_censustract_IBN$acs_50_or_more_2020_CT <- ifelse(bb_2020_censustract_IBN$bb_ACS_2020_CT >= .5, 1, 0)

bb_acs_2020_censustract_totalaccess <- bb_2020_censustract_IBN %>% 
     group_by(GEOID_County) %>% 
     summarise_at(vars(acs_50_or_more_2020_CT),
               list(sum))

bb_acs_2020_censustract_totaltracts <- count(bb_2020_censustract_IBN, "GEOID_County")

bb_counties_acs_2020_percentaccess <- merge(bb_acs_2020_censustract_totalaccess, bb_acs_2020_censustract_totaltracts, by = "GEOID_County")

bb_counties_acs_2020_percentaccess$percentaccess <- bb_counties_acs_2020_percentaccess$acs_50_or_more_2020_CT/bb_counties_acs_2020_percentaccess$freq

keeps <- c("GEOID_County", "percentaccess")
bb_counties_acs_2020_percentaccess = bb_counties_acs_2020_percentaccess[keeps]

bb_counties_acs_2020_percentaccess$acs_25per_counties_or_more_2020 <- ifelse(bb_counties_acs_2020_percentaccess$percentaccess >= .25, 1, 0)

bb_counties_acs_2020_percentaccess$acs_40per_counties_or_more_2020 <- ifelse(bb_counties_acs_2020_percentaccess$percentaccess >= .40, 1, 0)

bb_counties_acs_2020_percentaccess$acs_50per_counties_or_more_2020 <- ifelse(bb_counties_acs_2020_percentaccess$percentaccess >= .50, 1, 0)

bb_counties_acs_2020_percentaccess$acs_75per_counties_or_more_2020 <- ifelse(bb_counties_acs_2020_percentaccess$percentaccess >= .75, 1, 0)


##Ookla, Census-tracts with access in given counties 

full_df_censustract <- merge(full_df, bb_counties_acs_2020_percentaccess, by.x="GEOID", by.y="GEOID_County", all.x=TRUE)

full_df_censustract_control_acs <- full_df_censustract[full_df_censustract$ookla_50_or_more_2020== "0",]
...
LAU_employment_2020Janto2020Oct_Sensitivity <- read_xlsx("/Users/nikkivandenHeever/Documents/Documents/1_School/1_Carnegie Mellon/Research/2020-2022 NSF Rapid/Actual Data/Final Data Set for Nature Version/Employment/LAU_County_Jan2020Oct2020_COVIDinApril.xlsx")

LAU_employment_2020Janto2020Oct_Sensitivity <- merge(demo_county_2020, LAU_employment_2020Janto2020Oct_Sensitivity,  by.x="GEOID", by.y="GEOID", all.x=TRUE)

LAU_employment_2019Julyto2020Oct_Sensitivity <- rbind(LAU_employment_2019Julyto2019Dec, LAU_employment_2020Janto2020Oct_Sensitivity)

rm(LAU_employment_2019Julyto2019Dec)
rm(LAU_employment_2020Janto2020Oct_Sensitivity)

##Compiling Final Dataset

full_df_sensitivity <- merge(LAU_employment_2019Julyto2020Oct_Sensitivity, education, by.x="GEOID", by.y="GEOID", all.x=TRUE)
full_df_sensitivity <- merge(full_df_sensitivity, pop_density, by.x="GEOID", by.y="GEOID", all.x=TRUE)
full_df_sensitivity <- merge(full_df_sensitivity, bb, by.x="GEOID", by.y="GEOID", all.x=TRUE)

var_label(full_df_sensitivity) <- 
  list(percent_black = "Percent Pop Black",
       percent_natamerican = "Percent Pop Native American",
       percent_asian = "Percent Pop Asian",
       percent_hispanic = "Percent Pop Hispanic",
...
ols_2019msft_25_unemployment_sensitivty <- lm_robust(Unemployment_Rate_Percent ~ COVID_0_Pre_1_Post + msft_25_or_more_2019 + COVID_0_Pre_1_Post*msft_25_or_more_2019 + ed_growth_rate + percent_ed + log_pop_density + percent_black + percent_hispanic + percent_asian + percent_natamerican, clusters = state, data = full_df_sensitivity)

ols_2019msft_40_unemployment_sensitivty <- lm_robust(Unemployment_Rate_Percent ~ COVID_0_Pre_1_Post + msft_40_or_more_2019 + COVID_0_Pre_1_Post*msft_40_or_more_2019 + ed_growth_rate + percent_ed + log_pop_density + percent_black + percent_hispanic + percent_asian + percent_natamerican, clusters = state, data = full_df_sensitivity)

ols_2019msft_50_unemployment_sensitivty <- lm_robust(Unemployment_Rate_Percent ~ COVID_0_Pre_1_Post + msft_50_or_more_2019 + COVID_0_Pre_1_Post*msft_50_or_more_2019 + ed_growth_rate + percent_ed + log_pop_density + percent_black + percent_hispanic + percent_asian + percent_natamerican, clusters = state, data = full_df_sensitivity)

ols_2019msft_75_unemployment_sensitivty <- lm_robust(Unemployment_Rate_Percent ~ COVID_0_Pre_1_Post + msft_75_or_more_2019 + COVID_0_Pre_1_Post*msft_75_or_more_2019 + ed_growth_rate + percent_ed + log_pop_density + percent_black + percent_hispanic + percent_asian + percent_natamerican, clusters = state, data = full_df_sensitivity)

tb1 <-
  ols_2019msft_25_unemployment_sensitivty %>% 
  tbl_regression(estimate_fun = purrr::partial(style_ratio, digits = 2),) %>%
  add_glance_table(include = c(adj.r.squared, nobs)) %>%
  add_significance_stars(
    hide_se = TRUE,
...
tb2 <-
  ols_2019msft_40_unemployment_sensitivty %>% 
  tbl_regression(estimate_fun = purrr::partial(style_ratio, digits = 2),) %>%
  add_glance_table(include = c(adj.r.squared, nobs)) %>%
  add_significance_stars(
    hide_se = TRUE,
...
tb3 <-
  ols_2019msft_50_unemployment_sensitivty %>% 
  tbl_regression(estimate_fun = purrr::partial(style_ratio, digits = 2),) %>%
  add_glance_table(include = c(adj.r.squared, nobs)) %>%
  add_significance_stars(
    hide_se = TRUE,
...
tb4 <-
  ols_2019msft_75_unemployment_sensitivty %>% 
  tbl_regression(estimate_fun = purrr::partial(style_ratio, digits = 2),) %>%
  add_glance_table(include = c(adj.r.squared, nobs)) %>%
  add_significance_stars(
    hide_se = TRUE,
...
tbl_merge_2019_MSFT_sensitivty <- tbl_merge(
  list(tb1, tb2, tb3, tb4),
  tab_spanner = c("**Treat = 25% Penetration, 2019 MSFT**", "**Treat = 40% Penetration, 2019 MSFT**", "**Treat = 50% Penetration, 2019 MSFT**", "**Treat = 75% Penetration, 2019 MSFT**")) %>%
  modify_table_body(~.x %>% arrange(row_type == "glance_statistic")) %>%
  as_gt() %>%
  gt::tab_source_note(gt::md("*Difference-in-Difference regression results. Robust standard errors are clustered at the state level. P-values are two-tailed.*")) %>%
    gt::tab_header(title = "2019 MSFT - Full Set", subtitle = "Sensitivity to COVID in April")

gt::gtsave(tbl_merge_2019_MSFT_sensitivty, file = "/Users/nikkivandenHeever/Documents/Documents/1_School/1_Carnegie Mellon/Research/2020-2022 NSF Rapid/Writing/For Nature Journal/Final Regression Tables/2019 MSFT COVID in April.png")

ols_2020msft_25_unemployment_sensitivty <- lm_robust( Unemployment_Rate_Percent ~ COVID_0_Pre_1_Post + msft_25_or_more_2020 + COVID_0_Pre_1_Post*msft_25_or_more_2020 + ed_growth_rate + percent_ed + log_pop_density + percent_black + percent_hispanic + percent_asian + percent_natamerican, clusters = state, data = full_df_sensitivity)

ols_2020msft_40_unemployment_sensitivty <- lm_robust( Unemployment_Rate_Percent ~ COVID_0_Pre_1_Post + msft_40_or_more_2020 + COVID_0_Pre_1_Post*msft_40_or_more_2020 + ed_growth_rate + percent_ed + log_pop_density + percent_black + percent_hispanic + percent_asian + percent_natamerican, clusters = state, data = full_df_sensitivity)

ols_2020msft_50_unemployment_sensitivty <- lm_robust(Unemployment_Rate_Percent ~ COVID_0_Pre_1_Post + msft_50_or_more_2020 + COVID_0_Pre_1_Post*msft_50_or_more_2020 + ed_growth_rate + percent_ed + log_pop_density + percent_black + percent_hispanic + percent_asian + percent_natamerican, clusters = state, data = full_df_sensitivity)

ols_2020msft_75_unemployment_sensitivty <- lm_robust(Unemployment_Rate_Percent ~ COVID_0_Pre_1_Post + msft_75_or_more_2020 + COVID_0_Pre_1_Post*msft_75_or_more_2020 + ed_growth_rate + percent_ed + log_pop_density + percent_black + percent_hispanic + percent_asian + percent_natamerican, clusters = state, data = full_df_sensitivity)
...
tb2 <-
  ols_2020msft_40_unemployment_sensitivty %>% 
  tbl_regression(estimate_fun = purrr::partial(style_ratio, digits = 2),) %>%
  add_glance_table(include = c(adj.r.squared, nobs)) %>%
  add_significance_stars(
    hide_se = TRUE,
...
tb3 <-
  ols_2020msft_50_unemployment_sensitivty %>% 
  tbl_regression(estimate_fun = purrr::partial(style_ratio, digits = 2),) %>%
  add_glance_table(include = c(adj.r.squared, nobs)) %>%
  add_significance_stars(
    hide_se = TRUE,
...
tb4 <-
  ols_2020msft_75_unemployment_sensitivty %>% 
  tbl_regression(estimate_fun = purrr::partial(style_ratio, digits = 2),) %>%
  add_glance_table(include = c(adj.r.squared, nobs)) %>%
  add_significance_stars(
    hide_se = TRUE,
...
tbl_merge_2020_MSFT_sensitivity <- tbl_merge(
  list(tb1, tb2, tb3, tb4),
  tab_spanner = c("**Treat = 25% Penetration, 2020 MSFT**", "**Treat = 40% Penetration, 2020 MSFT**", "**Treat = 50% Penetration, 2020 MSFT**", "**Treat = 75% Penetration, 2020 MSFT**")) %>%
  modify_table_body(~.x %>% arrange(row_type == "glance_statistic")) %>%
  as_gt() %>%
  gt::tab_source_note(gt::md("*Difference-in-Difference regression results. Robust standard errors are clustered at the state level. P-values are two-tailed.*")) %>%
    gt::tab_header(title = "2020 MSFT - Full Set", subtitle = "Sensitivity to COVID in April")

gt::gtsave(tbl_merge_2020_MSFT_sensitivity, file = "/Users/nikkivandenHeever/Documents/Documents/1_School/1_Carnegie Mellon/Research/2020-2022 NSF Rapid/Writing/For Nature Journal/Final Regression Tables/2020 MSFTCOVID in April.png")
...
ols_2019msft_75_unemployment_notrobust_notclustered <- lm(Unemployment_Rate_Percent ~ COVID_0_Pre_1_Post + msft_75_or_more_2019 + COVID_0_Pre_1_Post*msft_75_or_more_2019 + ed_growth_rate + percent_ed + log_pop_density + percent_black + percent_hispanic + percent_asian + percent_natamerican, data = full_df)

ols_2019msft_75_unemployment_notrobust <- lm.cluster(full_df, Unemployment_Rate_Percent ~ COVID_0_Pre_1_Post + msft_75_or_more_2019 + COVID_0_Pre_1_Post*msft_75_or_more_2019 + ed_growth_rate + percent_ed + log_pop_density + percent_black + percent_hispanic + percent_asian + percent_natamerican, cluster = "state") 

ols_2019msft_75_unemployment_notclustered <- lm_robust(Unemployment_Rate_Percent ~ COVID_0_Pre_1_Post + msft_75_or_more_2019 + COVID_0_Pre_1_Post*msft_75_or_more_2019 + ed_growth_rate + percent_ed + log_pop_density + percent_black + percent_hispanic + percent_asian + percent_natamerican, data = full_df) 

ols_2019msft_75_unemployment_stataSE <- lm_robust(Unemployment_Rate_Percent ~ COVID_0_Pre_1_Post + msft_75_or_more_2019 + COVID_0_Pre_1_Post*msft_75_or_more_2019 + ed_growth_rate + percent_ed + log_pop_density + percent_black + percent_hispanic + percent_asian + percent_natamerican, clusters = state, se_type = "stata", data = full_df)

ols_2019msft_50_unemployment <- lm_robust(Unemployment_Rate_Percent ~ COVID_0_Pre_1_Post + msft_75_or_more_2019 + COVID_0_Pre_1_Post*msft_75_or_more_2019 + ed_growth_rate + percent_ed + log_pop_density + percent_black + percent_hispanic + percent_asian + percent_natamerican, clusters = state, data = full_df)
...
full_df_censustract_treat_plot = full_df_censustract_treat[keeps]

full_df_censustract_treat_plot <- full_df_censustract_treat_plot %>%
  pivot_wider(names_from = Period, values_from = Unemployment_Rate_Percent)

full_df_censustract_treat_plot <- full_df_censustract_treat_plot[, col_order]

full_df_censustract_treat_plot <- colMeans(full_df_censustract_treat_plot) 
